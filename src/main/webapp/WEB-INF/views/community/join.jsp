        ...
        <div class="row">
			<div class="row right-box">
				<div class="col-sm-3 right-box-img">
					<img src="/camping/resources/images/community/blogging.png" width="154"
						height="154">
				</div>
				<div class="col-sm-9 in-contents">
					...
					<div class="row">
						<div class="col-sm-7 trace">
							<span class="id-emphasis">수정</span>님이 <span
								class="location-emphasis">시애틀</span>에서 남긴포스트입니다
						</div>
